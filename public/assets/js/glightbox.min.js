!(function (t, e) {
    ...
    var h = (function () {
            function t(i, n) {
                ...
                (this.rotate = a(this.element, n.rotate || s)),
                    ...
                    (this.multipointStart = a(
                        this.element,
                        n.multipointStart || s
                    )),
                    (this.multipointEnd = a(
                        this.element,
                        n.multipointEnd || s
                    )),
                                ...
                                if (((this.isDoubleTap = !1), i > 1)) {
                                    ...
                                    null !== e.x &&
                                        ...
                                        null !== this.x2 && null !== this.sx2
                                            ? ((t.deltaX =
                                                  (n - this.x2 + r - this.sx2) /
                                                  2),
                                              (t.deltaY =
                                                  (s - this.y2 + a - this.sy2) /
                                                  2))
        ...
        return (
            ...
            S(d, function (e) {
                ...
                ((e.addEventListener && o && !i.found) || !o) &&
                    (e.addEventListener(t, u, h),
                    i.all.push({ eventName: t, fn: u }));
            }),
            u
        );
    }
    ...
    function D(t, e) {
        ...
        return (
            ...
            (t.height =
                w.has(t, "height") && "" !== t.height ? P(t.height) : n),
            t
        );
    }
    var X = function () {
        ...
        B = function () {
            ...
            if (
                ...
                return (
                    ...
                    l.insertBefore(
                        N('<div class="gvideo-wrapper"></div>'),
                        l.firstChild
                    ),
            ...
            if ("inline" !== s) {
                if ("image" === s) {
                    ...
                    return (
                        ...
                        "" !== i.description &&
                            f.setAttribute("aria-describedby", p),
        ...
        "file" == r && (r = "http"),
            ...
            _(this.settings.plyr.js, "Plyr", function () {
                ...
                if (null !== l.match(/\.(mp4|ogg|webm|mov)$/)) {
                    a = "local";
                    var d = '<video id="' + s + '" ';
                    (d += 'style="background:#000; max-width: '.concat(
                        e.width,
                        ';" '
                    )),
                        (d += 'preload="metadata" '),
                ...
                var y = w.has(n.settings.plyr, "config")
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        if (
                            ...
                            (this.lightboxOpen = !0),
                            w.isFunction(this.settings.onOpen) &&
                            ...
                            L(t, this.settings.openEffect, function () {
                                !d &&
                                    ...
                                    w.isFunction(i.settings.afterSlideChange) &&
                                        i.settings.afterSlideChange.apply(i, [
                                            o,
                                            l,
                                        ]);
                            });
                            ...
                            L(
                                ...
                                function () {
                                    ...
                                    A(g, "glightbox-open"),
                                        ...
                                        w.isFunction(t.settings.onClose) &&
                                            t.settings.onClose();
                                    var n =
